...
### 다크패턴스캐너
- [다크패턴 스캐너 — 쇼핑몰 다크패턴 자동 진단 프로토타입](다크패턴스캐너/README.md) — 카운트다운 리셋 탐지·체크아웃 단계별 총액 추적을 Playwright로 구현한 1차 프로토타입, fixture 6종으로 자체 검증. [기획서](다크패턴스캐너/기획서.md)에 시장 근거·경쟁 조사·수익화 검토 정리
