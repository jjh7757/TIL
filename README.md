...
| 2026-08-04 | [반응형 웹과 모바일 퍼스트](CS지식/반응형웹과모바일퍼스트.md) |
...
- [맛집 추천 서비스 구현 정리](vercel실습/맛집추천서비스/맛집추천서비스구현.md) — 화면 4개 스크린샷과 구현 내용 정리 (구현 저장소: [jjh7757/bitebudget](https://github.com/jjh7757/bitebudget))
...
- [반응형 웹과 모바일 퍼스트](CS지식/반응형웹과모바일퍼스트.md) — 미디어 쿼리·뷰포트 기반 반응형 웹과, 모바일 화면을 기준으로 먼저 설계하는 모바일 퍼스트 전략 비교
